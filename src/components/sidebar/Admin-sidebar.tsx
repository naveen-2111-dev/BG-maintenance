            ...
            <SidebarContent className="flex flex-col h-full border-none">
                    ...
                    <SidebarGroup>
                        <SidebarGroupContent>
                            <SidebarMenu className="space-y-2">
                                {AdminSidebarComponents.map((item) => {
                                    return (
                ...
                <div className="border-t border-slate-100 px-4 py-4">
                    <SidebarMenu className="space-y-1">
                        <div className="m-2 text-justify bg-yellow-200 p-3 border-l-4 border-yellow-500">
                            <p className="text-red-600 text-sm mb-4 font-semibold">
                                ⚠️Warning : This is the BG Admin Panel. Please use it wisely. Do not reveal the admin secrets to anyone, as it may lead to a huge disaster.
                            </p>
                        </div>
